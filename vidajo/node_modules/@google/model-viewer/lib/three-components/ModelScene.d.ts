import { AnimationActionLoopStyles, Box3, Camera, Event as ThreeEvent, Material, Mesh, Object3D, PerspectiveCamera, Scene, Sphere, Texture, Vector2, Vector3, WebGLRenderer } from 'three';
...
export declare class ModelScene extends Scene {
    ...
    bakedShadows: Set<Mesh<import("three").BufferGeometry<import("three").NormalBufferAttributes>, Material | Material[], import("three").Object3DEventMap>>;
    exposure: number;
