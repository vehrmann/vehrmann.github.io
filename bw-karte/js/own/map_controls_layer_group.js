function group_map_control() {
    let group_headers = {
        ...
        [overlay_bergwacht_eignungstest_winter_20240204.name]:  {   'header':           'Bergwacht Eignungstests',
                                                                    'first_item':       true,
                                                                    'opacity_slider':   true,
                                                                    'default_opacity':  [overlay_bergwacht_eignungstest_winter_20240204.opacity]
                                                                },
...
function updateOverlayOpacity(overlay_type, opacity_value) {
    switch(overlay_type) {
        ...
        case 'Schutzgebiete':
            ...
            break;
        case 'Bergwacht Eignungstests':
            bergwacht_ausbildung_maps[overlay_bergwacht_eignungstest_winter_20240204.name].setStyle({
                opacity:        opacity_value,
                fillOpacity:    opacity_value
            });
            break;
...
addLayerControlClass(layer_control_bergwacht_ausbildung,    'layer-control-bergwacht-eignungstests');
