(function (factory, window) {
    ...
    L.Measure = {
        linearMeasurement:          "Distanz messen",
        areaMeasurement:            "Fläche messen",
        start:                      "Start",
        meter:                      "m",
        meterDecimals:              0,
        kilometer:                  "km",
    ...
    L.Control.Measure = L.Control.extend({
        ...
        _buildItems: function () {
            ...
            //ele_li = L.DomUtil.create("li", "leaflet-measure-action", ele_ul);                    // not needed, duplicate
            //var ele_link_area = L.DomUtil.create("a", "leaflet-measure-action start", ele_li);    // leaflet-measure-action not needed (??)
            var ele_link_area = L.DomUtil.create("a", "start leaflet-measure-action-area", ele_li);
